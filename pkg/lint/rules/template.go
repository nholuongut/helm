/*
Copyright The Nho Luong Authors.
...
func TemplatesWithSkipSchemaValidation(linter *support.Linter, values map[string]interface{}, namespace string, kubeVersion *chartutil.KubeVersion, skipSchemaValidation bool) {
	...
	// See https://github.com/nholuongut/helm/issues/9658
	...
	*/
	for _, template := range chart.Templates {
		...
		// NOTE: disabled for now, Refs https://github.com/nholuongut/helm/issues/1463
		...
		// NOTE: disabled for now, Refs https://github.com/nholuongut/helm/issues/1037
		...
		if strings.TrimSpace(renderedContent) != "" {
			...
			for {
				...
				// fix https://github.com/nholuongut/helm/issues/11391
				...
				if yamlStruct != nil {
					...
					// Refs https://github.com/nholuongut/helm/issues/8596
...
//
// See https://github.com/nholuongut/helm/issues/8467
...
// See https://github.com/nholuongut/helm/issues/1990
